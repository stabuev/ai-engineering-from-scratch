...
- [3Blue1Brown — «Essence of Linear Algebra»](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab) — лучшая визуальная интуиция для векторов, матриц и преобразований.
- [Гилберт Стрэнг — MIT 18.06 Linear Algebra](https://ocw.mit.edu/courses/18-06-linear-algebra-spring-2010/) — классический курс линейной алгебры, бесплатно на MIT OpenCourseWare.
