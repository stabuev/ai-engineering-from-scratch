...
- Строить детектор подделок (AASIST / RawNet2), отличающий настоящую речь от синтезированной.
- Встраивать и восстанавливать аудио-водяной знак (AudioSeal) и измерять точность восстановления битов.
- Читать результаты ASVspoof 5 и называть брешь, которую используют злоумышленники.
