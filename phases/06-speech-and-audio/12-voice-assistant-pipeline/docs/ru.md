...
- Собирать уроки 01–11 в голосового ассистента, который слушает, рассуждает и отвечает.
- Связывать VAD-гейтированный захват реплики в потоковый цикл STT → LLM → TTS.
- Диагностировать три режима отказа (barge-in, end-pointing, wake word).
