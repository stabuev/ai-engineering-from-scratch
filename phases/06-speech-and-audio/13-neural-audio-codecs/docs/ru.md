...
- Объяснять residual vector quantization (RVQ) и как кодеки превращают формы волны в дискретные токены.
- Различать семантические и акустические токены и почему частота кадров важна для языкового моделирования.
- Сравнивать EnCodec, SNAC, Mimi и DAC по качеству восстановления и битрейту.
