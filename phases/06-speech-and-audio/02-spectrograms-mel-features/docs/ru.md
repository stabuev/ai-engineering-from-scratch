...
- Превращать форму волны в log-mel спектрограмму через фреймирование, окно Ханна, STFT и mel-фильтрбанк.
- Объяснять, почему нейросети лучше усваивают mel-спектрограммы, чем сырые формы волны.
- Выводить MFCC из log-mel.
