...
- Генерировать музыку токенной LM над токенами нейрокодека (MusicGen) и добавлять обусловливание мелодией.
- Противопоставлять подходы token-LM, diffusion и гибридные продакшен-решения.
- Оценивать через FAD и CLAP и называть юридическую проблему.
