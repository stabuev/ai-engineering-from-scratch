...
- Отделять идентичность диктора от содержания и клонировать голос zero-shot.
- Реализовывать преобразование голоса (KNN-VC) и встраивать водяной знак.
- Рассуждать об этике и детекции (SECS, AASIST) клонирования голоса.
