...
- Объяснять ASR как пошаговую классификацию, склеенную sequence-моделью, и противопоставлять CTC, RNN-T и attention.
- Реализовывать жадное и beam-search CTC-декодирование и считать WER.
- Запускать инференс против Whisper и настраивать потоковый ASR.
