...
- Называть правильную метрику 2026 для каждой аудио-задачи (ASR, TTS, диктор, диаризация, классификация).
- Вычислять WER/CER, MOS/UTMOS, SECS, EER и DER.
- Объяснять проверку round-trip WER-on-ASR для оценки TTS.
