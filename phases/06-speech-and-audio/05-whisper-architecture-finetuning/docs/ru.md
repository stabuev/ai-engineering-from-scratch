...
- Объяснять энкодер-декодер Whisper с 30-секундным окном, обученный на слабо-размеченных парах аудио-текст.
- Запускать Whisper из коробки, нарезать длинное аудио и дообучать его через LoRA.
- Распознавать и смягчать галлюцинации Whisper.
