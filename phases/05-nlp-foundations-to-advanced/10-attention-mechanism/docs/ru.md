...
- Реализовывать аддитивное (Bahdanau) и мультипликативное (Luong) внимание с разобранным численным примером.
- Объяснять схему query/key/value и матрицу выравнивания.
- Объяснять, почему этот механизм — мост к трансформерам.
