...
- Строить rule-based извлекатель слотов и цикл обновления состояния по репликам.
- Управлять DST через LLM и структурированный вывод.
- Оценивать через Joint Goal Accuracy (JGA).
