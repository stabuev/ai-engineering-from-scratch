...
- Реализовывать BM25 с нуля и плотный поиск bi-encoder'ом.
- Сливать их через Reciprocal Rank Fusion и добавлять переранжирование cross-encoder'ом.
- Оценивать поиск метрикой Recall@k.
