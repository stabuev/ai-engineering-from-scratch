...
- Обучать skip-gram word2vec с negative sampling на игрушечном корпусе.
- Воспроизводить арифметику аналогий в выученном пространстве эмбеддингов.
- Различать статические и контекстные эмбеддинги и обрабатывать OOV-слова.
