...
- Извлекать отношения паттернами, supervised-классификацией и LLM-промптингом с привязкой.
- Канонизировать тройки на закрытую онтологию.
- Строить небольшой граф знаний и запрашивать его.
