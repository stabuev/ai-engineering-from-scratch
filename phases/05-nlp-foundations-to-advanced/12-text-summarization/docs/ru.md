...
- Строить экстрактивную суммаризацию через TextRank и абстрактивную через BART.
- Оценивать через ROUGE и объяснять его слепые зоны.
- Диагностировать проблему фактологичности / галлюцинаций в абстрактивных резюме.
