...
- Строить энкодер-декодер с teacher forcing и жадным циклом инференса.
- Демонстрировать узкое место фиксированного контекст-вектора, мотивирующее внимание.
- Объяснять teacher forcing, exposure bias и beam search.
