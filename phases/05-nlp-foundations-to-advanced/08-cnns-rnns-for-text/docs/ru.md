...
- Объяснять признаки n-грамм (свертки) против памяти (рекуррентность) и проблему затухающего градиента.
- Объяснять, почему внимание вытеснило оба — и где они все еще подходят для ограниченного железа.
