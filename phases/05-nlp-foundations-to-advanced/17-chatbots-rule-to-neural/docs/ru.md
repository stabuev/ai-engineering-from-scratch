...
- Строить чатбота каждой эпохи: правила-паттерны, retrieval-FAQ, нейрогенерация, LLM agent loop и гибридная маршрутизация.
- Прослеживать, что каждая эпоха решила и что оставила открытым.
- Распознавать prompt injection в чатботе с инструментами.
