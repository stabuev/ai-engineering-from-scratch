...
- Противопоставлять требующую доказательства машину Геделя Шмидхубера и эмпирическую Darwin-Gödel Machine.
- Объяснять, почему доказуемо-полезная самомодификация непрактична и что ее заменяет.
