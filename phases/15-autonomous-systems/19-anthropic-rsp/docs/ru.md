...
- Читать дифф RSP v3.0 против v2 — что добавлено, убрано и переформулировано.
- Объяснять двухуровневый график смягчений и порог AI R&D-4.
- Рассуждать, почему более вылизанная политика может оказаться менее строгой.
