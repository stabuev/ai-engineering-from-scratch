...
- Называть четыре примитива, ограничивающих цикл самоулучшения (формальные инварианты, якоря выравнивания и прочее).
- Объяснять, как каждый примитив ограничивает правку.
- Применять примитивы к гипотетическому самоправящемуся агенту.
