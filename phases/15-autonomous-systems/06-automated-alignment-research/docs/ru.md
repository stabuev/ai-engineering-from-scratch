...
- Объяснять устройство параллельных автономных агентов-исследователей выравнивания, координирующихся через общий форум.
- Рассуждать, почему исследование выравнивания — кандидат на автоматизацию, и о его рисках.
- Определять структуру надзора вокруг таких агентов.
