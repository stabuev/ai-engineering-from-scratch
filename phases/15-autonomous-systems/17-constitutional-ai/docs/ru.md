...
- Объяснять переход от правил к рассуждению в выравнивании в Claude Constitution 2026.
- Описывать её четырёхуровневую иерархию приоритетов.
- Рассуждать, что значит публикация конституции модели под CC0.
