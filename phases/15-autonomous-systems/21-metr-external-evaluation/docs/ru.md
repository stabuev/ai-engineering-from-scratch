...
- Объяснять роль METR как независимого оценщика и его бенчмарк Time Horizon.
- Читать логистическую подгонку горизонта времени и что означает его время удвоения.
- Рассуждать, почему внешняя оценка важна для заявлений о frontier-моделях.
