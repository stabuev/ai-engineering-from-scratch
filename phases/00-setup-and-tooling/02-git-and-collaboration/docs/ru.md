...
> Контроль версий — не опция. Каждый эксперимент, каждая модель и каждый урок, который вы создаете здесь, должны отслеживаться.
...
2. Отправляйте изменения в удаленный репозиторий (`git push`)
...
Вот и все. Для этого курса вам не нужны rebase, cherry-pick или submodules.

## Упражнения

1. Клонируйте этот репозиторий, создайте ветку `my-progress`, создайте файл, закоммитьте его и отправьте в удаленный репозиторий
...
|------|----------------|----------------------|
| Commit | «Сохранение» | Снимок всего проекта в определенный момент времени |
| Branch | «Копия» | Указатель на коммит, который движется вперед по мере вашей работы |
| Merge | «Объединение кода» | Применение изменений из одной ветки к другой |
| Remote | «Облако» | Копия репозитория, размещенная где-то еще (GitHub, GitLab) |
