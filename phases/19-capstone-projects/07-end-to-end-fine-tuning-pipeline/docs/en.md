...
- Build an end-to-end pipeline: fine-tune an 8B model on your data, DPO-align it, quantize, and serve it.
- Measure cost in $/1M tokens and latency.
- Add speculative decoding to the serving path.
