...
- Build a constitutional safety harness plus a red-team range.
- Combine an input/output classifier (Llama Guard-style) with constitutional self-critique.
- Score the harness against red-team attacks.
