...
- Объяснять, почему многоагентное обучение нарушает предположение о стационарности одноагентного RL.
- Реализовывать независимый Q-learning и обновление с централизованным обучением и децентрализованным исполнением (CTDE).
- Настраивать простой self-play для двухагентной состязательной игры.
