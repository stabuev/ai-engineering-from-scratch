...
- Собирать DQN из Q-learning плюс experience replay и target-сеть и объяснять, как каждый прием стабилизирует аппроксимацию функции.
- Называть смертельную триаду (бутстрэппинг + off-policy + аппроксимация) и как трюки DQN ее обезвреживают.
