...
- Прокатывать политику на маленьком MDP и точно вычислять ее функцию ценности по уравнению Беллмана.
- Объяснять, что задает коэффициент дисконтирования γ и почему у него есть физический смысл (эффективный горизонт).
