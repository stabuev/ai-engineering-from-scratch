...
- Объяснять эмерджентную Theory of Mind высокого порядка у кооперирующихся LLM-агентов.
- Применять тест Салли-Энн и измерение координации Ридла.
- Строить минимального ToM-осознанного агента и замечать иллюзию координации.
