...
- Строить трёхчастную архитектуру генеративного агента (поток памяти, рефлексия, планирование).
...
2. **Importance scores дешевы.** Вызывайте LLM для оценки importance 1-10 во время записи. Кешируйте score.
...
| Importance | "Насколько агенту важно" | Самооценка 1-10 во время записи. Кешируется. |
