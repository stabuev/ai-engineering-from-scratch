...
- Реализовывать PSO и ACO над выходами LLM (LMPSO, Model Swarms).
- Сопоставлять скорость частицы с промптом, а феромонные следы — с маршрутизацией агентов.
- Связывать био-вдохновленную оптимизацию с поиском агентов.
