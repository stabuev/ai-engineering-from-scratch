...
- Implement the Du et al. multi-agent debate algorithm.
- Tune its two independent knobs (agents, rounds) and explain why debate works.
- Set up heterogeneous debate across different models.
