...
- Объяснять пятислойный стек экономики агентов начиная с DePIN.
- Применять атрибуцию вклада по значению Шепли и аукционы второй цены для агрегации.
- Рассуждать о репутационном капитале автономных агентов.
