...
- Раскладывать задачу на роли planner, executor, critic и verifier.
- Реализовывать SOP-паттерн MetaGPT и коммуникативную дегаллюцинацию ChatDev.
- Объяснять, почему роль verifier важнее всего и чем critic отличается от verifier.
