...
- Объяснять иерархическую архитектуру как вложенные supervisor'ы и где возникает decomposition drift.
- Определять, где иерархия блистает, а где ломается.
- Использовать решающий вопрос для выбора иерархии против плоской команды.
