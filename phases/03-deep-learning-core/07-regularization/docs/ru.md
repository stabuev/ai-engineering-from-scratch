...
Останавливайтесь, когда test loss не улучшался `patience` эпох, и восстанавливайте лучший снимок. Каждая эпоха после лучшей точки — чистое переобучение (train accuracy растет, а test стоит), поэтому вы экономите ровно этот хвост вычислений — обычно сотни эпох из бюджета в 1000.
