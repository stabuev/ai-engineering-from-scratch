...
- Разбивать одноголовое внимание на несколько голов и собирать их обратно через выходную проекцию W_o.
- Запускать scaled-dot-product attention по головам и реализовывать варианты GQA и MQA.
- Исследовать, что выучивает каждая отдельная голова внимания.
