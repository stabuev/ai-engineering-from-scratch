...
- Объяснять форму энкодер-декодер для задач вход→выход и как cross-attention связывает два стека.
- Противопоставлять span corruption у T5 и многошумовое denoising-предобучение BART.
- Выбирать между вариантами энкодер-декодер для перевода / суммаризации / переписывания в 2026.
