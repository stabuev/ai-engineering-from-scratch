...
- Обусловливать GAN меткой или входным изображением, подавая условие и в G, и в D.
- Строить image-to-image модель в стиле Pix2Pix с U-Net-генератором и PatchGAN-дискриминатором.
- Противопоставлять парную (Pix2Pix) и непарную (CycleGAN) трансляцию изображений.
