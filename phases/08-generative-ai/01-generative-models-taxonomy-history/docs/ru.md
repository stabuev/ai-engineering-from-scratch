...
- Относить любую генеративную модель к одному из пяти семейств (авторегрессия, VAE, GAN, diffusion/score, flow) и называть допущение о плотности каждого.
- Объяснять различие явной и неявной плотности и что даёт генеративной модели гипотеза о многообразии.
- Выбирать правильное семейство под новую модальность, прежде чем неделями бороться с её математикой.
