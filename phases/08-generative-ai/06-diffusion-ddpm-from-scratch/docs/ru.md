...
- Реализовывать прямой зашумляющий процесс в замкнутой форме и сэмплировать x_t за один шаг.
- Обучать денойзер с ε-предсказанием и запускать обратный цикл сэмплирования.
- Различать ε-предсказание и v-предсказание и читать расписание β / ᾱ.
