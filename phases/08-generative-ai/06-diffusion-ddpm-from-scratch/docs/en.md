...
- Implement the closed-form forward noising schedule and sample x_t in one shot.
- Train an ε-prediction denoiser and run the reverse sampling loop.
- Distinguish ε-prediction from v-prediction and read the β / ᾱ schedule.
