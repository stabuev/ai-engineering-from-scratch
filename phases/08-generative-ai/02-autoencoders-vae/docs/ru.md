...
- Реализовывать энкодер VAE, репараметризацию z = μ + σ·ε и декодер, способный сэмплировать.
- Выводить и оптимизировать ELBO, балансируя реконструкцию и KL-член к приору.
- Распознавать коллапс апостериорного распределения и объяснять, как β-VAE балансирует реконструкцию и распутывание.
