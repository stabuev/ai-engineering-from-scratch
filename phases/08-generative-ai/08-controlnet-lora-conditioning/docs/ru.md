...
- Направлять замороженную диффузионную модель структурным сигналом (глубина, поза, грани) через side-сеть ControlNet с нулевой инициализацией.
- Реализовывать низкоранговое обновление LoRA и выбирать ранг r и α.
- Сравнивать ControlNet, LoRA, IP-Adapter и DreamBooth по тому, что каждый обусловливает или адаптирует.
