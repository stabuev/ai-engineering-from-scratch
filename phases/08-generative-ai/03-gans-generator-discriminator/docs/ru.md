...
- Обучать пару генератор–дискриминатор с non-saturating loss.
- Объяснять минимаксную игру и почему GAN полностью обходят явную плотность.
- Диагностировать mode collapse и называть стабилизаторы против него (WGAN, spectral norm).
