...
**Тип:** Сборка + изучение
**Языки:** Python
**Предварительные требования:** Phase 4 Lesson 06 (YOLO), Phase 4 Lesson 07 (U-Net)
**Время:** ~75 минут
...
4. **RoIAlign** — выбирает фрагмент признаков фиксированного размера (например, 7x7) из любой рамки на любом уровне FPN. Билинейная выборка, без квантизации.
...
Каждое число находится в билинейно выбранной позиции. Никакого округления, никакого квантизации, никаких отброшенных градиентов.
...
### Шаг 6: Заморозка того, что не нужно обучать
