# Зрение реального времени — развертывание на edge
...
1. **Разогрейте** модель 5-10 фиктивными forward pass перед измерением. Холодные кэши и JIT-компиляция дают нерепрезентативные первые числа.
