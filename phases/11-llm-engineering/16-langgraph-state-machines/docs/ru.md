...
- Строить ReAct-агента как LangGraph-конечный автомат с чекпоинтами.
- Объявлять типизированное состояние с редьюсерами и добавлять human-in-the-loop прерывание.
- Менять чекпоинтер на продакшен и использовать time-travel для отладки.
