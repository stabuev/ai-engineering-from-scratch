...
Правило большого пальца: если инструмент доступен только для чтения, кэшируемый и вызывается из двух или более хостов, выпускайте его как MCP-сервер. Если это одноразовая встроенная логика, оставьте ее локальной функцией (Фаза 11 · 09).
